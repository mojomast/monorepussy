...
from cavity import __version__
...
def cmd_modes(args: argparse.Namespace) -> int:
    ...
    from cavity.modes import compute_natural_frequencies, format_modes, predict_deadlocks
...
def cmd_monitor(args: argparse.Namespace) -> int:
    ...
    from cavity.beat_frequency import format_beat_frequencies
    from cavity.standing_wave import format_standing_waves
    ...
    from cavity.beat_frequency import detect_livelock
...
def detect_standing_waves_with_names(signal, fs, window, resource_names):
    ...
    from cavity.standing_wave import detect_standing_waves
