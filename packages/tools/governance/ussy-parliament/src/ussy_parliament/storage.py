...
from ussy_parliament.models import Agent, Appeal, EntryType, JournalEntry, Motion, PointOfOrder, Session, Vote
...
class SQLiteStore:
    ...
    def _row_to_poo(self, row: sqlite3.Row) -> PointOfOrder:
        from ussy_parliament.models import ViolationType
    ...
    def _row_to_appeal(self, row: sqlite3.Row) -> Appeal:
        from ussy_parliament.models import RulingOutcome
