...
from curator.catalog import MARCRecord
from curator.classification import classify_document, FacetedClassification
...
from curator.provenance import ProvenanceTracker
from curator.storage import Storage
from curator.utils import parse_yaml_frontmatter, vectorize
from curator.weeding import WeedingEngine
...
def _build_collection(paths: list[Path]) -> list[Document]:
    ...
    from curator.utils import extract_markdown_links
    for doc in docs:
        doc.backlinks = [
