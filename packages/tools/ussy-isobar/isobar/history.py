...
from isobar.fields import AtmosphericField, AtmosphericProfile, compute_fields
from isobar.scanner import ScanResult, GitScanner, FileHistory
...
def compute_historical_fields(
    ...
    while current <= now:
        ...
        for filepath, history in scan_result.file_histories.items():
            ...
            if filtered_commits:
                from isobar.scanner import FileHistory as FH
