...
from ussy_steno import __version__
from ussy_steno.engine import ScannerEngine
from ussy_steno.formatters import get_formatter
from ussy_steno.models import ScanResult
...
def create_parser() -> argparse.ArgumentParser:
    ...
    scan_parser = subparsers.add_parser(
        "scan", help="Scan files/directories for steganographic content"
    )
    ...
    diff_parser.add_argument("ref", help="Git diff reference (e.g., HEAD~1, main..feature, abc123)")
