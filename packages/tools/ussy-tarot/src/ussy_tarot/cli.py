...
from ussy_tarot.cards import CardRegistry, DecisionCard, load_card_from_markdown
from ussy_tarot.engine import MonteCarloEngine, SpreadResult
from ussy_tarot.readings import ReadingGenerator, FullReading, format_reading
from ussy_tarot.bayesian import BayesianUpdater, OutcomeObservation
from ussy_tarot.evidence import EvidenceCollector, EvidenceItem, IncidentRecord
from ussy_tarot.community import CommunityDatabase
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if command is None or command == "version":
        from ussy_tarot import __version__
