...
from stratagit.core.parser import is_git_repo, parse_commits, assign_branch_names, compute_stability, classify_intrusions
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="stratagit",
        description="StrataGit — Geological metaphor for Git history visualization",
    )
    parser.add_argument(
        "-C", "--repo",
        default=".",
