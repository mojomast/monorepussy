...
from mushin import __version__
...
def cmd_init(args: argparse.Namespace) -> int:
    from mushin.storage import mushin_root
...
def cmd_list(args: argparse.Namespace) -> int:
    from mushin.workspace import list_workspaces, get_active_workspace_id
...
def cmd_delete(args: argparse.Namespace) -> int:
    from mushin.workspace import delete_workspace
...
def cmd_branch(args: argparse.Namespace) -> int:
    from mushin.branching import BranchManager
...
def cmd_bookmark(args: argparse.Namespace) -> int:
    from mushin.bookmarks import BookmarkManager
    from mushin.workspace import get_active_workspace_id
...
def cmd_diff(args: argparse.Namespace) -> int:
    ...
    from mushin.diff import diff_workspaces
...
def cmd_info(args: argparse.Namespace) -> int:
    from mushin.workspace import Workspace, get_active_workspace_id, list_workspaces
    from mushin.branching import BranchManager
    from mushin.bookmarks import BookmarkManager
