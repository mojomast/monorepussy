...
from ussy_cyclone import __version__
...
def _resolve_source(source: str) -> str:
    ...
    """
    from ussy_cyclone.survey import discover_config
...
def cmd_survey(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import survey, format_survey
...
def cmd_vorticity(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.vorticity import compute_vorticity_field, format_vorticity
...
def cmd_detect(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.detect import detect_cyclones, format_detection
...
def cmd_track(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.cisk import detect_cisk
    from ussy_cyclone.detect import detect_cyclones, track_cyclone
...
def cmd_cisk(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.cisk import detect_cisk, format_cisk
...
def cmd_stability(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.stability import compute_all_stability, format_stability
...
def cmd_pv(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.pv import compute_pv, check_pv_conservation, simulate_scale_down, format_pv
...
def cmd_forecast(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.forecast import forecast, format_forecast
...
def cmd_category(args: argparse.Namespace) -> None:
    ...
    from ussy_cyclone.survey import load_topology
    from ussy_cyclone.cisk import detect_cisk
    from ussy_cyclone.detect import detect_cyclones
    from ussy_cyclone.category import classify_pipeline, format_category
